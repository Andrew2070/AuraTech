...
--[[Functions]]--
local accounts = {
  ["Andrew2070"] = "3765", --Replace User1 with your Username, and password1 with your password
  ["User2"] = "password2"
...
local valid
  red()
  print("          Skynet Defense Systems Active  ")
  red()
  print("             [Strategic Air Command]   ")
  red()
...
term.setCursorPos(1,1)
 local count, x, y, z
  ...
  print("                [Target Selection]    ")
      ...
      write(" Missile Count: ")
      count = tonumber(read())
      print("Enter Strike Coordinates:")
      write("X: ")
      x = tonumber(read())
      write("Y: ")
      y = tonumber(read())
...
term.setCursorPos(1,1)
  ...
  print("  Do you wish to Abort [Y/N]?   ")
      red()
      write(" Do you wish to Abort [Y/N]:  ")
local abort = read()
if abort == "Yes" then
os.reboot()
